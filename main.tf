...
global:
  ingress:
    ...
    port: 80
  buckets:
    hostedFileBucket: "${terraform.workspace}-${var.hosted_file_bucket}"
postgres:
...
variable "hosted_file_bucket" {
  description = "the hosted file bucket name (workspace will be prefix'd)"
  default     = "hosted-dataset-files"
}
